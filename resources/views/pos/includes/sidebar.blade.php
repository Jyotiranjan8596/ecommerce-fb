    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item {{ request()->is('user/management*') ? 'active' : '' }}">
                ...
                <div class="multi-level collapse" id="submenu-app-acc">
                    <ul class="flex-column nav">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pos.payment.index') }}">
                                <span class="sidebar-text">Payment</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pos.sattlement') }}">
                                <span class="sidebar-text">Receipt Journal</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pos.ledger.index') }}">

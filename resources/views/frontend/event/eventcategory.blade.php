        ...
        <div class="d-flex justify-content-center mt-5">
            <div class="content text-center">
                ...
                <p class="breadcrumb">
                    ...
                    <span><a href="{{ route('frontend.eventCategory') }}" class="text--base"
                            style="color: red">Events</a></span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="row gy-5 mt-2 main-content">
        @foreach ($eventCategory as $data)
            <div
                ...
                <div class="card">
                    <a href="{{ route('event.view',$data->id) }}" style="color: black; text-decoration: none;">

                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="mt-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        name="email" value="{{ old('email') }}" placeholder="example@company.com"
                                        id="email" autofocus required />
                                    <br>
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                        ...
                                        name="mobilenumber" value="{{ old('mobilenumber') }}" id="mobilenumber"
                                        autofocus required />
                                    <br>
                                    @error('mobilenumber')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('sponsor_id') is-invalid @enderror"
                                        name="sponsor_id" value="{{ old('sponsor_id') }}" id="sponsor_id" autofocus
                                        required />
                                    <br>
                                    @error('sponsor_id')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            {{-- Parent of level form  --}}
                            <div class="form-group mb-4">
                                <label for="email">Parent for Level</label>
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon1">
                                        <svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <input type="text"
                                        ...
                                        name="parent_level" value="{{ old('parent_level') }}" id="parent_level"
                                        autofocus required />
                                    <br>
                                    @error('parent_level')
                                        <span class="invalid-feedback" role="alert">

                    ...
                    <svg width="50px" height="50px" viewBox="-2.4 -2.4 28.80 28.80" fill="none"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <path
                                ...
                                stroke="#444cc5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path
        ...
        <div class="row g-4 row-cols-1 row-cols-lg-3" style="padding: 10px !important;">
            <div class="col d-flex align-items-start"
                ...
                <div>
                    ...
                    <p style="color: black !important;">The IPO (Inflation Protection Offer) is a movement against

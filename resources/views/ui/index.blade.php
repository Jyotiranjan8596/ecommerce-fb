    ...
    <div class="container-lg">
        <div class="row">
            <div class="col-lg-6 pt-5 mt-5">
                ...
                <p class="fs-4">Fresh, healthy, and organic groceries delivered straight to your home.</p>
                <div class="d-flex gap-3">
                    <a href="{{ route('register') }}" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Register</a>
                    <a href="{{ route('login') }}"
                        class="btn btn-dark text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Login</a>
                </div>
                <div class="row my-5">
                    <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="card-body p-0">
                                ...
                                <p class="card-text">
                                    Sourced directly from trusted farmers to ensure freshness and quality.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="card-body p-0">
                                ...
                                <p class="card-text">
                                    Our products are completely organic, free from pesticides and chemicals.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="card-body p-0">
                                ...
                                <p class="card-text">
                                    Enjoy fast and free delivery on all orders, right to your doorstep!
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="product-item">
                                <figure>
                                    <a href="{{ route('frontend.product', $data->id) }}"
                                        title="{{ $data->title }}">
                                        <img src="{{ asset('images/' . $data->image) }}" alt="{{ $data->title }}"
                                            class="tab-image" />
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                                    <h3 class="fs-6 fw-normal">{{ $data->title }}</h3>
                                    <div>
                                        <span class="rating">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center gap-2">
                                        <del>₹{{ $data->price }}</del>
                                        <span class="text-dark fw-semibold">₹{{ $data->total_price }}</span>
                                        <span
                                            class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">₹{{ $data->discount_price }}
                                            OFF</span>
                                    </div>
                ...
                <div class="swiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-21.png') }}"
                                        alt="Product Thumbnail" class="tab-image" />
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
